...
@section('content')
    ...
    <div class="bg0 m-t-23 p-b-140 filter_bar">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <!-- Filter -->
                    <div class=" panel-filter w-full">
                        <div class="wrap-filter flex-w  w-full p-lr-10  p-lr-15-sm">
                            {{-- filter-col1 p-b-27 --}}
                            <div class="">
                            ...
                            <div class="col-lg-12" style="margin-left: -20px;">
                                ...
                                <form action="{{ url('priceFilter') }}">
                                    @csrf
                                    <div class="d-flex">
                                        <input type="text" name="min" id="min"
                                            class="border form-control mx-1">
                                        <input type="text" name="max" id="max"
                                            class="border form-control mx-1">
                                        <button><img src="{{ asset('filter-3.png') }}" alt=""
                                                class="border filter_button"></button>
                                    </div>
                                </form>
                            </div>
