...
@section('content')
    ...
    <div class="container main">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="{{ url('men') }}" class="stext-109 cl8 hov-cl1 trans-04">
                Men
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
    ...
    <section class="sec-product-detail bg0 p-t-65 p-b-60">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-7 p-b-30 gal_image" >
                    <div class="p-l-25 p-r-30 p-lr-0-lg" >
                        <div class="wrap-slick3 flex-sb flex-w" >
                            ...
                            <div class="slick3 gallery-lb" >
                                <div class="item-slick3" data-thumb='{{ '/public/uploads/' . $product->productImage }}'>
                                    <div class="wrap-pic-w pos-relative">
                                        <img src='{{ '/public/uploads/' . $product->productImage }}' alt="IMG-PRODUCT" height="600px">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href='{{ '/public/uploads/' . $product->productImage }}'>
                                ...
                                @foreach (json_decode($product->productImage1) as $images)
                                    <div class="item-slick3" data-thumb='{{ '/public/uploads/' . $images }}'>
                                        <div class="wrap-pic-w pos-relative">
                                            <img src='{{ '/public/uploads/' . $images }}' alt="IMG-PRODUCT" height="600px">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                href='{{ '/public/uploads/' . $images }}'>
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <p class="stext-102 cl3 p-t-23 text-left">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="size-204 flex-w flex-m respon6-next">
                                    ...
                                    <button
                                        ...
                                        <a href="" class="text-white text-decoration-none">Add to cart</a>
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="bor10 m-t-50 p-t-43 p-b-40 tab">
                <!-- Tab01 -->
                <div class="tab01">
                    <!-- Nav tabs -->
        ...
        {{-- <div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
            ...
            <span class="stext-107 cl6 p-lr-25">
                Categories: {{ $product->category->Category_name }}, Men
            </span>
        </div> --}}
    </section>
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src='{{ '/public/uploads/' . $relatedProducts->productImage }}' alt="IMG-PRODUCT">
                                <a href="#"
