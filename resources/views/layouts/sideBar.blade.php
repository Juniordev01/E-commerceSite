<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ url('product_page') }}" class=" nav-link "><i
                        data-feather="command"></i><span>Products</span></a>
            </li>
